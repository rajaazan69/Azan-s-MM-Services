        ...
        if (interaction.isButton()) {
            ...
            if (interaction.customId.startsWith('close_ticket_')) {
                ...
                try {
                    ...
                    try {
                        await interaction.followUp({ content: '❌ There was an error closing the ticket. Please check the console.', ephemeral: true });
                    } catch (followUpError) {
            ...
            if (interaction.customId && interaction.customId.startsWith('finish_log_ticket_')) {
                ...
                try {
                    ...
                    await interaction.editReply({ content: '✅ MM point logged, feedback sent. Deleting ticket now...' });
                    ...
                    try {
                        await interaction.editReply({ content: '❌ An error occurred while finishing the ticket. Check the console.' });
                    } catch (editError) {
            ...
            if (interaction.customId.startsWith('mm_request_modal_')) {
                ...
                try {
                    ...
                    await thread.send({ content: initialThreadContent, embeds: [ticketEmbed], components: [row] }); 
