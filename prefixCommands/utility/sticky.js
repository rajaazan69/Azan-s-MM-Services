    ...
    async execute(message, args, client) {
        ...
        if (action === 'remove') {
            ...
            if (client.db.stickyMessages[targetChannel.id]) {
                ...
                saveDB(client.db);
                return message.reply({ content: `✅ Sticky message configuration removed for ${targetChannel}.` });
            } else {
        ...
        if (action === 'set') {
            ...
            return message.reply({ content: `✅ Sticky message has been set/updated for ${targetChannel}. It will now appear after new messages.` });
        }
